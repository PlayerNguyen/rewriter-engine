...
export const typography = {
  ...
  "display-lg": { size: "56px", weight: 600, lineHeight: 1.10, letterSpacing: "-1.8px" },
  ...
  "body-lg": { size: "18px", weight: 400, lineHeight: 1.50, letterSpacing: "-0.1px" },
  body: { size: "16px", weight: 400, lineHeight: 1.50, letterSpacing: "-0.05px" },
  "body-sm": { size: "14px", weight: 400, lineHeight: 1.50, letterSpacing: "0" },
