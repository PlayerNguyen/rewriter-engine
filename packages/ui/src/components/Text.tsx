...
type TextAs = "h1" | "h2" | "h3" | "h4" | "h5" | "h6" | "p" | "span" | "label" | "blockquote" | "code";
type TextSize = "display-xl" | "display-lg" | "display-md" | "headline" | "card-title" | "subhead" | "body-lg" | "body" | "body-sm" | "caption" | "button" | "eyebrow" | "mono";
type TextWeight = 400 | 500 | 600 | 700;
type TextColor = "ink" | "ink-muted" | "ink-subtle" | "ink-tertiary" | "primary" | "inverse-ink" | "inherit";
