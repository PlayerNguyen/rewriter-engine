...
const meta: Meta<typeof Text> = {
  ...
  argTypes: {
    ...
    as: {
      control: 'select',
      options: ['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p', 'span', 'label', 'blockquote', 'code'],
    },
  },
};
...
export const Truncated: Story = {
  args: {
    truncate: true,
    children:
      'This is a very long text that should be truncated with an ellipsis when it reaches the container boundary. It keeps going and going and going.',
    style: { width: 300 },
  },
};
...
export const LineClamp: Story = {
  args: {
    truncate: 2,
    children:
      'This text is clamped to two lines. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.',
    style: { width: 300 },
  },
};
...
export const SemanticElements: Story = {
  render: () => (
    <div className="space-y-2">
      ...
      <Text as="label" size="body-sm">
        Rendered as label
      </Text>
      <Text as="code" size="mono">
        Rendered as code
      </Text>
    </div>
  ),
