...
const spacingMap: Record<string, string> = {
  xxs: "4px", xs: "8px", sm: "12px", md: "16px", lg: "24px", xl: "32px", xxl: "48px", section: "96px", auto: "auto", "0": "0",
};

const radiusMap: Record<string, string> = {
  xs: "4px", sm: "6px", md: "8px", lg: "12px", xl: "16px", xxl: "24px", pill: "9999px", full: "9999px",
};
...
export const Box = forwardRef<HTMLElement, BoxProps>(
  (
    ...
    if (px !== undefined) { spacingStyle.paddingLeft = spacingMap[px] || String(px); spacingStyle.paddingRight = spacingMap[px] || String(px); }
    if (py !== undefined) { spacingStyle.paddingTop = spacingMap[py] || String(py); spacingStyle.paddingBottom = spacingMap[py] || String(py); }
    ...
    if (mx !== undefined) { spacingStyle.marginLeft = spacingMap[mx] || String(mx); spacingStyle.marginRight = spacingMap[mx] || String(mx); }
    if (my !== undefined) { spacingStyle.marginTop = spacingMap[my] || String(my); spacingStyle.marginBottom = spacingMap[my] || String(my); }
